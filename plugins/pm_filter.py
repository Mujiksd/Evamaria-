...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(f'📟 ᴍᴏᴠɪᴇꜱ 📟', url='https://t.me/+MQ73rnaco09hMjg9'),
            InlineKeyboardButton(f'🕹️ ꜱᴇʀɪᴇꜱ 🕹️', url='https://t.me/+1UnwU-IMhKFiNjdl'),
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[            
            InlineKeyboardButton('🔸ɢʀᴏᴜᴘ 1🔸', url='https://t.me/+dJVLGHpfxH04ZGQ1'),
            ...
            InlineKeyboardButton('🔗 ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ 🔗', url=f'https://t.me/+MQ73rnaco09hMjg9')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
